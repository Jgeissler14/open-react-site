          ...
          {/* <div className="mx-auto mb-4 w-full">
              ...
              <h3 className="h3 mb-3">Free Trial</h3>
                ...
                <div className="text-gray-700 font-medium mt-1 mb-4 pt-5">
                  <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out" target="_blank" href="https://calendly.com/cloudzap/introduction">Free Consultation</a>
                </div>
            ...
            <div className="mx-auto mb-4 w-full ml-4">
              <div className="md:pr-4 lg:pr-12 xl:pr-16">
                ...
                <div data-aos="fade-up" data-aos-delay="400">
                  <a className="btn text-white bg-purple-600 hover:bg-purple-700 w-full sm:w-auto sm:mb-0" target="_blank" href="https://buy.stripe.com/28o4iz07jgcueVabIT">Hire Engineer</a>
                </div>
                <div className="text-gray-700 font-medium mt-1 mb-4 pt-5">
                  <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out" href="https://calendly.com/cloudzap/introduction" target="_blank">Free Consultation</a>
                </div>
                <ul className="text-lg text-gray-400 -mb-2 pt-5 border-t border-gray-700">
                  <li className="flex items-center mb-2">
                    <span className="inline-block w-2 h-2 mr-2 bg-gray-400 rounded-full"></span>
