...
import FeatImage01 from '@/public/images/images/features-03-image-01.png'
import FeatImage02 from '@/public/images/images/features-03-image-02.png'
import FeatImage03 from '@/public/images/images/features-03-image-03.png'
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <p className="text-xl text-gray-400 mb-4">Don't like meetings? We don't either; so much so that we've outlawed them completely. Manage your infrastructure board asynchrnously using Trello. View active, queued, and completed tasks with ease. </p>
